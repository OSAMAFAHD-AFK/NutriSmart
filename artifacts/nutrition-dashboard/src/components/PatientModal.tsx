...
import { X, User, Phone, MapPin, Scale, Ruler, Upload } from "lucide-react";
import {
  type Patient,
  type Diagnosis,
  GOVERNORATES,
...
export default function PatientModal({ patient, onSave, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-card border border-card-border rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
